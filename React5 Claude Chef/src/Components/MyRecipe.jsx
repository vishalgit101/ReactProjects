...
/*export function MyRecipe(props) {
  console.log("Recipe inside of MyREcipe Comp: " + props);
  return (
    <section>
...
export function MyRecipe(props) {
  //console.log("Recipe inside of MyREcipe Comp: " + props);
  console.log("Raw recipe prop:", props.recipe);
  console.log("Type:", typeof props.recipe);
  // be carefull, extra space between markdown is going to cause problem for you
  return (
